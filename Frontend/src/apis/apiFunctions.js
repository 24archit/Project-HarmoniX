...
export async function getTopTracksIndia() {
  try {
    return await fetchData(
      "http://localhost:2424/api/getTopTracksIndia", "GET", 
...
export async function getTopTracksGlobal() {
  try {
    return await fetchData(
      "http://localhost:2424/api/getTopTracksGlobal","GET",
...
export async function getArtistData(id) {
  try {
    return await fetchData(
      `http://localhost:2424/api/getArtistData?id=${id}`,"GET",
...
export async function getArtistAlbums(id) {
  try {
    return await fetchData(
      `http://localhost:2424/api/getArtistAlbums?id=${id}`,"GET",
      `Failed to fetch albums for artist id ${id}`
    );
  } catch (error) {
    throw new Error(`Error fetching albums for artist id ${id}: ${error.message}`);
  }
}
...
export async function getArtistTopTracks(id) {
  try {
    return await fetchData(
      `http://localhost:2424/api/getArtistTopTracks?id=${id}`,"GET",
      `Failed to fetch top tracks for artist id ${id}`
    );
  } catch (error) {
    throw new Error(`Error fetching top tracks for artist id ${id}: ${error.message}`);
  }
}
...
export async function getUserTopArtists(number) {
  try {
    return await fetchData(
      `http://localhost:2424/api/getUserTopArtists?number=${number}`,"GET",
      `Failed to fetch top artists for user with number ${number}`
    );
  } catch (error) {
    throw new Error(`Error fetching top artists for user with number ${number}: ${error.message}`);
  }
}
...
export async function getUserInfo() {
  try {
    return await fetchData(
      "http://localhost:2424/api/getUserInfo","GET",
